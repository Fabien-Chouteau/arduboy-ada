package body Arduboy.Screen is
   ...
   Arduboy_Logo : constant Bitmap :=
     (16#F0#, 16#F8#, 16#9C#, 16#8E#, 16#87#, 16#83#, 16#87#, 16#8E#, 16#9C#, 16#F8#,
      16#F0#, 16#00#, 16#00#, 16#FE#, 16#FF#, 16#03#, 16#03#, 16#03#, 16#03#, 16#03#,
      16#07#, 16#0E#, 16#FC#, 16#F8#, 16#00#, 16#00#, 16#FE#, 16#FF#, 16#03#, 16#03#,
      16#03#, 16#03#, 16#03#, 16#07#, 16#0E#, 16#FC#, 16#F8#, 16#00#, 16#00#, 16#FF#,
      16#FF#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#FF#, 16#FF#,
      16#00#, 16#00#, 16#FE#, 16#FF#, 16#83#, 16#83#, 16#83#, 16#83#, 16#83#, 16#C7#,
      16#EE#, 16#7C#, 16#38#, 16#00#, 16#00#, 16#F8#, 16#FC#, 16#0E#, 16#07#, 16#03#,
      16#03#, 16#03#, 16#07#, 16#0E#, 16#FC#, 16#F8#, 16#00#, 16#00#, 16#3F#, 16#7F#,
      16#E0#, 16#C0#, 16#80#, 16#80#, 16#C0#, 16#E0#, 16#7F#, 16#3F#, 16#FF#, 16#FF#,
      16#01#, 16#01#, 16#01#, 16#01#, 16#01#, 16#01#, 16#01#, 16#FF#, 16#FF#, 16#00#,
      16#00#, 16#FF#, 16#FF#, 16#0C#, 16#0C#, 16#0C#, 16#0C#, 16#1C#, 16#3E#, 16#77#,
      16#E3#, 16#C1#, 16#00#, 16#00#, 16#7F#, 16#FF#, 16#C0#, 16#C0#, 16#C0#, 16#C0#,
      16#C0#, 16#E0#, 16#70#, 16#3F#, 16#1F#, 16#00#, 16#00#, 16#1F#, 16#3F#, 16#70#,
      16#E0#, 16#C0#, 16#C0#, 16#C0#, 16#E0#, 16#70#, 16#3F#, 16#1F#, 16#00#, 16#00#,
      16#7F#, 16#FF#, 16#C1#, 16#C1#, 16#C1#, 16#C1#, 16#C1#, 16#E3#, 16#77#, 16#3E#,
      16#1C#, 16#00#, 16#00#, 16#1F#, 16#3F#, 16#70#, 16#E0#, 16#C0#, 16#C0#, 16#C0#,
      16#E0#, 16#70#, 16#3F#, 16#1F#, 16#00#, 16#00#, 16#00#, 16#00#, 16#00#, 16#01#,
      16#FF#, 16#FF#, 16#01#, 16#00#, 16#00#, 16#00#);
               ...
               if Icol + Root.X >= 0 then
                  if Buffer_Row >= 0 then
                     declare
                        ...
                        Data : constant Unsigned_8 :=
                          Shift_Left (Bmp (Bmp'First + Bmp_Index),
                                      Natural (Yoffset));
                     begin
                        if On then
                  ...
                  then
                     declare
                        ...
                        Data : constant Unsigned_8 :=
                          Shift_Right (Bmp (Bmp_Index), Natural (8 - Yoffset));
                     begin
                        if On then
                           FB (FB_Index) := FB (FB_Index) or Data;
                        else
